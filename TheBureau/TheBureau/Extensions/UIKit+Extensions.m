...
@implementation UIButton (Pulse_Animation)
-(void)animatePulseWithCompletionBlock:(void (^)(void))completion{
    typeof(self) __weak weakSelf = self;
    [UIView animateWithDuration:0.2 animations:^{
        weakSelf.transform = CGAffineTransformMakeScale(1.25, 1.25);
